...
class AccidentDetection:
                    ...
                    if results is not None:
                        for box in results.boxes:
                            ...
                            if conf > self.conf_threshold:
                                ...
                                output_path = self.output_dir / f"accident_{timestamp}.jpg"
    ...
    def detect_accident(video_paths):
        ...
        MODEL_PATH = r"D:\ANPR-and-ATCC-for-Smart-Traffic-Management-main\models\accident_best.pt"
...
if __name__ == "__main__":
    AccidentDetection.detect_accident([
        r"D:\ANPR-and-ATCC-for-Smart-Traffic-Management-main\sample detection videos\accident.mp4",
