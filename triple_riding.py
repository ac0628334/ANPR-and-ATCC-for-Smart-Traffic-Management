...
# Only run this when triple_riding.py is executed directly
if __name__ == "__main__":
    # Input video path
    video_path = r"D:\ANPR-and-ATCC-for-Smart-Traffic-Management-main\sample detection videos\triple riding.mp4"
